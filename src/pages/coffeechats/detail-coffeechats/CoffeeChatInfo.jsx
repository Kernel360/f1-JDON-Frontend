import { Box, Divider, Typography, Button, InputAdornment, TextField } from '@mui/material';
  ...
  return (
    <>
      ...
      <Box
        ...
        <InfoItem icon={<CalendarMonthIcon />} text={formattedDate} iconColor="#FF6565" />

        <InfoItem icon={<AccessTimeFilledIcon />} text={formattedTime} iconColor="#52BF91" />
      ...
      <TotalInputForm value={false} label="오픈채팅 링크">
        <TextField
          ...
          sx={URLInput}
          ref={inputRef}
          value={hasAuthenticate ? coffeeChatData.openChatUrl : '신청 후 확인 가능합니다'}
          InputProps={{
            readOnly: true,
            disabled: true,
