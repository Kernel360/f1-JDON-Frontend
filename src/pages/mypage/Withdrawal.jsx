...
function Withdrawal() {
  ...
  return (
    ...
    >
      ...
      <Box >
        <h1>회원탈퇴</h1>
        회원탈퇴 후 같은 소셜 계정으로 재 가입이 불가능하며,<br /><br />
        삭제된 모든 내용은 복구할 수 없습니다. <br /> <br />

        또한, 본인의 부주의로 인해 회원 탈퇴가 되는 경우, <br /> <br />당사는 책임지지 않습니다.
        <br /><br />
        <br />
        <FormControlLabel
          control={
            <Checkbox checked={checkState} onChange={checkBoxHandler} name="123123" />
          }
          label="위의 사항을 확인했으며, 회원탈퇴를 하겠습니다."
        />
      </Box>
