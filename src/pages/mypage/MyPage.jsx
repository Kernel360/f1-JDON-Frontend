...
import { Container, Box, Avatar, Button, Typography, Grid, IconButton } from '@mui/material';
  ...
  const noticeLists = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          content: '- 법령에서 정하는 경우를 제외하고는 제3자에게 제공하지 않습니다.',
        },
        {
          title: '5. 개인 정보의 파기',
          content:
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: '7. 문의 및 민원',
          content: '- 서비스 이용에 관한 문의 및 민원은 어플리케이션 내 [고객센터]를 통해 접수됩니다.',
        },
      ],
    },
  ];
